...
PS1="${Red}k${Yellow}a${Green}n${Cyan}g${Blue}s${Purple}k${White}@docker[debian10-nvidia]:${Blue}\w# ${NC}"
...
export LD_LIBRARY_PATH="/usr/local/cuda/lib64:/usr/local/cuda-11.2/bin:$LD_LIBRARY_PATH"